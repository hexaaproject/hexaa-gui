...
angular.module('hexaaApp.services')
    .service('profileService', ['PrincipalFacade', 'HexaaService', 'logoutUrl', '$rootScope', 'events', PrincipalFacadeService]);

function PrincipalFacadeService(PrincipalFacade, HexaaService, logoutUrl, $rootScope, events) {
    ...
    function refresh() {
        return PrincipalFacade.getPrincipal()
