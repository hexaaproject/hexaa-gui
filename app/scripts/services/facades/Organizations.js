...
angular.module('hexaaApp.services.facades').factory('OrganizationsProxy', ['$http', '$rootScope', '$q', 'HexaaService', 'RolesProxy', 'InvitationsProxy', 'ResourceEntity', 'OrganizationFactory', function ($http, $rootScope, $q, HexaaService, RolesProxy, InvitationsProxy, ResourceEntity, OrganizationFactory) {
        ...
        getInvitations: function (id, pager) {
            ...
            request.success(function (data, status, header, config) {
                angular.forEach(data.items, function (item) {
                    items.push(InvitationsProxy.new(item));
                });
