...
angular.module('hexaaApp.services.facades').factory('RolesProxy', ['$http', '$rootScope', '$q', 'HexaaService', 'RoleFactory', function ($http, $rootScope, $q, HexaaService, RoleFactory) {
