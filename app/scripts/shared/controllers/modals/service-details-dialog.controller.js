...
(function () {
    ...
    angular.module('hexaaApp.shared.controllers.modals')
        ...
        ['$scope', '$modalInstance', 'serviceId', 'ServicesFacade', 'dialogService', '$translate',
            function ($scope, $modalInstance, serviceId, ServicesFacade, dialogService, $translate) {
        ...
        function activate() {
            ServicesFacade.getService(serviceId)
