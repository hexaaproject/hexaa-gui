...
(function (window, undefined) {
    ...
    linq_helper.processDeferredSort = function (collection) {
        ...
        collection.array.sort(function (x, y) {
            return compare(x, y, collection.deferredSort);
        });
        collection.deferredSort = null;
    };

    linq_helper.identity = function (x) {
        return x;
    };

    linq_helper.isString = function (x) {
        return (typeof x === 'string' || x instanceof String);
    };
    linq_helper.isBoolean = function (x) {
        return (typeof x === 'boolean' || x instanceof Boolean);
    };
    linq_helper.isNumber = function (x) {
    ...
    linq_helper.caseSensitiveComparer = function (x, y) {
        return (x < y ? -1 : x > y ? 1 : 0);
    };
    linq_helper.defaultStringComparer = linq_helper.caseSensitiveComparer;
    linq_helper.strictComparer = function (x, y) {
        return (x === y);
    };
    ...
    linq.prototype = {
        ...
        distinctBy: function (keySelector, comparer) {
            ...
            return this.groupBy(keySelector, null, comparer)
                .select(function (x) {
                    return (new linq(x.values, false)).first();
                });
        },
        ...
        thenBy: function (keySelector, comparer) {
            ...
            results.deferredSort = linq_helper.extendDeferredSort(this.deferredSort, {
