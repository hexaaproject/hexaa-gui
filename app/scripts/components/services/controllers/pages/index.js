    ...
    angular.module('hexaaApp.components.services.controllers.pages').controller('ServicesCtrl', [
        ...
        function ($scope, ServicesProxy, $route, $translate, events, dialogService, $location, settingsService, $modal, pageTitleService) {
            ...
            function activate() {
                ...
                ServicesProxy.getServices().then(getServicesSuccess); //Load Services
            ...
            function onEntityIdsModalClosed(service) {
                return function (contact) {
                    if (contact !== 'close') {
                        ServicesProxy.notifySP(service.id, contact)
            ...
            function onGetEntityIdsSuccess(service) {
                return function (data) {
                    var modalInstance = $modal.open({
                        templateUrl: 'views/components/services/modals/entityIdContactDialog.html',
            ...
            function onDeleteServiceDialogClosed(service) {
                return function (answer) {
                    if (answer == 'yes') {
                        ServicesProxy.deleteService(service.id)
            ...
            function openServiceChanger() {
                var modalInstance = $modal.open({
                    templateUrl: 'views/components/services/modals/serviceChangerDialog.html',
