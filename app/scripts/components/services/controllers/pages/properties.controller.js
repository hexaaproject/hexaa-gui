...
(function () {
    ...
    angular.module('hexaaApp.components.services.controllers.pages')
        ...
        ['$scope', 'ServicesFacade', '$translate', 'events', '$upload', 'baseAddr', '$q', 'dialogService', 'pageTitleService',
            function ($scope, ServicesFacade, $translate, events, $upload, baseAddr, $q, dialogService, pageTitleService) {
