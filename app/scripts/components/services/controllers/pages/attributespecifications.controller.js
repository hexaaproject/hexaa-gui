...
(function () {
    ...
    angular.module('hexaaApp.components.services.controllers.pages')
        ...
        ['$scope', 'AttributeSpecificationsFacade', '$translate', 'events', 'ServicesFacade', 'dialogService', 'pageTitleService',
        function ($scope, AttributeSpecificationsFacade, $translate, events, ServicesFacade, dialogService, pageTitleService) {
            ...
            function activate() {
                ...
                AttributeSpecificationsFacade.getAttributeSpecifications().then(onGetAttributeSpecificationsSuccess);
            ...
            function onServiceSave(event, selectedService) {
                if (($scope.service.id != -1) &&
                    ...
                    ServicesFacade.updateAttributeSpecifications($scope.service)
            ...
            function onServiceSelectionChanged(event, selectedService) {
                ...
                if (selectedService ) {
                    ...
                    ServicesFacade.getAttributeSpecifications(selectedService).then(onGetServiceAttributeSpeficiationsSuccess);
                }
            }
