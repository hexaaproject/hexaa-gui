...
(function () {
    ...
    angular.module('hexaaApp.components.services.controllers.pages')
        ...
        ['$scope', '$rootScope', '$translate', 'events', 'ServicesFacade', 'tags', 'dialogService', 'pageTitleService',
            function ($scope, $rootScope, $translate, events, ServicesFacade, tags, dialogService, pageTitleService) {
                ...
                function refreshFeed(service) {
                    ...
                    ServicesFacade.getNews(service.id, ($scope.pager.currentPage - 1) * $scope.pager.itemPerPage, $scope.pager.itemPerPage, tags)
