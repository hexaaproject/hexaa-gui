...
(function () {
    ...
    angular.module('hexaaApp.components.services.controllers.pages')
        .controller('ServiceManagersCtrl', ['$scope', 'ServicesProxy', '$cookies', '$translate', 'events', 'PrincipalProxy', 'dialogService', 'pageTitleService',
        function ($scope, ServicesProxy, $cookies, $translate, events, PrincipalProxy, dialogService, pageTitleService) {
