...
(function () {
    ...
    angular.module('hexaaApp.components.services.controllers.pages').controller('ServicesInvitationsCtrl', ['$scope', '$window', '$timeout', 'InvitationsFacade', 'ServicesFacade', '$cookies', '$modal', '$translate', 'events', 'dialogService', 'baseUIAddr', 'pageTitleService',
        function ($scope, $window, $timeout, InvitationsFacade, ServicesFacade, $cookies, $modal, $translate, events, dialogService, baseUIAddr, pageTitleService) {
            ...
            function refreshInvitations()
            {
                ...
                {
                    ServicesFacade.getInvitations($scope.service.id, $scope.pager)
