...
(function () {
    ...
    angular.module('hexaaApp.components.services.controllers.pages')
        .controller('ServiceNewCtrl', ['$scope', 'HexaaService',  '$translate', '$modalInstance', 'ServicesProxy', 'dialogService',
            function ($scope, HexaaService, $translate, $modalInstance, ServicesProxy, dialogService) {
