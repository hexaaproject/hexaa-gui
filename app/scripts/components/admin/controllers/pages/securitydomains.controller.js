...
(function () {
    ...
    angular.module('hexaaApp.components.admin.controllers.pages')
        .controller('AdminSecurityDomainsCtrl',
            [  '$translate', 'dialogService', '$modal', 'pageTitleService','SecurityDomainsFacade',
            function (  $translate, dialogService, $modal, pageTitleService, SecurityDomainsFacade) {
                ...
                function create(targetSecurityDomain) {
                    var modalInstance = $modal.open({
                        templateUrl: 'views/components/admin/modals/new-security-domain-dialog.html',
                        controller: 'AdminNewSecurityDomainDialogCtrl as vm',
                        resolve: {
                            targetSecurityDomain: function () {
                                return targetSecurityDomain || SecurityDomainsFacade.new();
                            }
                        }
                    });
