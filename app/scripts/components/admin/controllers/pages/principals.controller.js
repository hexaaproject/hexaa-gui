...
(function () {
    ...
    angular.module('hexaaApp.components.admin.controllers.pages')
        .controller('AdminPrincipalsCtrl', [ 'PrincipalFacade', '$translate', 'dialogService', '$modal', 'pageTitleService',
            function ( PrincipalFacade, $translate, dialogService, $modal, pageTitleService) {
                ...
                function create(targetPrincipal) {
                    var modalInstance = $modal.open({
                        templateUrl: 'views/components/admin/modals/new-principal-dialog.html',
                        controller: 'AdminNewPrincipalDialogCtrl as vm',
                        resolve: {
                            targetPrincipal: function () {
                                return targetPrincipal || PrincipalFacade.new();
                            }
                        }
                    });
