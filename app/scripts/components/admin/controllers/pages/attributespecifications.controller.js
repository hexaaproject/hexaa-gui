...
(function () {
    ...
    angular.module('hexaaApp.components.admin.controllers.pages')
        ...
        ['$scope', 'AttributeSpecificationsFacade', '$translate', 'dialogService', '$modal', 'pageTitleService',
            function ($scope, AttributeSpecificationsFacade, $translate, dialogService, $modal, pageTitleService) {
                ...
                function create(targetAttrSpec) {
                    var modalInstance = $modal.open({
                        templateUrl: 'views/components/admin/modals/new-attrspec-dialog.html',
                        controller: 'AdminNewAttributeSpecificationDialogCtrl as vm',
                        resolve: {
                            targetAttributeSpecification: function () {
                                return targetAttrSpec || AttributeSpecificationsFacade.new();
                            }
                        }
                    });
                 ...
                 */
                function activate() {
                    AttributeSpecificationsFacade.getAttributeSpecifications(vm.pager)
