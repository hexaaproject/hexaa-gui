...
(function () {
    ...
    angular.module('hexaaApp.components.admin.controllers.modals')
        ...
        ['$translate', 'dialogService', '$modalInstance', 'targetSecurityDomain','SecurityDomainsFacade','OrganizationsFacade', 'ServicesFacade',
            function ( $translate, dialogService, $modalInstance, targetSecurityDomain,SecurityDomainsFacade, OrganizationsFacade, ServicesFacade) {
                ...
                function activate() {
                    ...
                    SecurityDomainsFacade.getScopedKeys()
