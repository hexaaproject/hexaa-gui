...
(function () {
    ...
    angular.module('hexaaApp.components.organizations.controllers.pages')
        ...
        ['$scope', 'OrganizationsProxy', '$translate', 'events', 'dialogService', 'pageTitleService','$q',
            function ($scope, OrganizationsProxy, $translate, events, dialogService, pageTitleService,$q) {
                ...
                function onOrganizationsSelectionChanged(event, selectedOrganization) {
                    if (selectedOrganization !== undefined) {
                        ...
                        $q.all({
                            organization: OrganizationsProxy.getOrganization(selectedOrganization)
                                .catch(onGetOrganizationError),
                            roles: OrganizationsProxy.getRoles(selectedOrganization)
