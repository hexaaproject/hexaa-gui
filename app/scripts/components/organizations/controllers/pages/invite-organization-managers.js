...
(function () {
    ...
    angular.module('hexaaApp.components.organizations.controllers.pages').controller('InviteOrganizationManagersCtrl', ['$scope', '$modal', 'dialogService', '$translate', 'InvitationsFacade', 'baseUIAddr', 'events', 'OrganizationsFacade', function ($scope, $modal, dialogService, $translate, InvitationsFacade, baseUIAddr, events, OrganizationsFacade) {
        ...
        function onOrganizationsSelectionChanged(event, selectedOrganization) {
            if (selectedOrganization ) {
                OrganizationsFacade.getOrganization(selectedOrganization).then(onGetOrganizationSuccess);
            }
        }
