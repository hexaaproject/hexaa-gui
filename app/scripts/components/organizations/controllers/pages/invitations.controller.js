...
(function () {
    ...
    angular.module('hexaaApp.components.organizations.controllers.pages')
        ...
        ['$scope', 'OrganizationsFacade', '$modal', '$translate', 'events', 'InvitationsFacade', 'dialogService', 'pageTitleService',
        function ($scope, OrganizationsFacade, $modal, $translate, events, InvitationsFacade, dialogService, pageTitleService) {
            ...
            function loadInvitations() {
                OrganizationsFacade.getInvitations(vm.organization.id, vm.pager)
