...
(function () {
    ...
    angular.module('hexaaApp.components.organizations.controllers.pages')
        ...
        ['$scope', 'EntitlementpacksFacade', 'OrganizationsFacade', 'events', '$translate', '$modal', 'dialogService', 'pageTitleService',
            function ($scope, EntitlementpacksFacade, OrganizationsFacade, events, $translate, $modal, dialogService, pageTitleService) {
                ...
                function onCurrentPageChanged(newValue, oldValue) {
                    if (vm.organization.id != -1) {
                        EntitlementpacksFacade.getPublicEntitlementpacks(vm.pager)
                ...
                function add(entitlementpack) {
                    OrganizationsFacade.addEntitlementpack(vm.organization, entitlementpack)
                ...
                function remove(entitlementpack) {
                    OrganizationsFacade.deleteEntitlementpack(vm.organization.id, entitlementpack.id)
                ...
                function onOrganizationsSelectionChanged(event, selectedOrganization) {
                    if (selectedOrganization) {
                        ...
                        OrganizationsFacade.getEntitlementpacks(selectedOrganization)
