...
(function () {
    ...
    angular.module('hexaaApp.components.organizations.controllers.pages').controller('OrganizationRolesCtrl', ['$scope', '$window', '$timeout', 'dialogService', 'OrganizationsProxy', '$cookies', '$q', '$rootScope', '$translate', 'events', '$modal', 'RolesProxy', 'PrincipalProxy', 'pageTitleService', 'profileService',
        function ($scope, $window, $timeout, dialogService, OrganizationsProxy, $cookies, $q, $rootScope, $translate, events, $modal, RolesProxy, PrincipalProxy, pageTitleService, profileService) {
             ...
             */
            function loadRoles() {
                OrganizationsProxy.getRoles(vm.organization.id)
            ...
            function onRoleSaveSuccess(role) {
                return function (data) {
                    ...
                    vm.organization.roles.push(RolesProxy.new(role));
                }
            }
