...
(function () {
    ...
    angular.module('hexaaApp.components.organizations.controllers.pages')
        ...
        ['$scope', 'events', 'OrganizationsFacade', 'tags', 'dialogService', 'pageTitleService', '$translate',
            function ($scope, events, OrganizationsFacade, tags, dialogService, pageTitleService, $translate) {
                ...
                function refreshFeed(organization) {
                    if (organization.id) {
                        ...
                        OrganizationsFacade.getNews(organization.id, ($scope.pager.currentPage - 1) * $scope.pager.itemPerPage, $scope.pager.itemPerPage, tags).
