...
(function () {
    ...
    angular.module('hexaaApp.components.organizations.controllers.pages')
        ...
        ['$scope', 'OrganizationsFacade', '$route', '$translate', 'events', 'dialogService', 'settingsService', '$modal', 'pageTitleService',
        function ($scope, OrganizationsFacade, $route, $translate, events, dialogService, settingsService, $modal, pageTitleService) {
            ...
            function activate() {
                ...
                OrganizationsFacade.getOrganizations()
            ...
            function onDeleteOrganizationDialogAnswered(organization) {
                return function (answer) {
                    if (answer === 'yes') {
                        OrganizationsFacade.deleteOrganization(organization).success(onOrganizationDeleteSuccess(organization)).
            ...
            function openOrganizationChanger() {
                var modalInstance = $modal.open({
                    templateUrl: 'views/components/organizations/modals/organization-changer-dialog.html',
