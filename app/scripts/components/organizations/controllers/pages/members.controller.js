...
(function () {
    ...
    angular.module('hexaaApp.components.organizations.controllers.pages')
        ...
        ['$scope', 'HexaaService', 'PrincipalFacade', '$translate', 'events', 'OrganizationsFacade', 'dialogService', 'pageTitleService',
            function ($scope, HexaaService, PrincipalFacade, $translate, events, OrganizationsFacade, dialogService, pageTitleService) {
                ...
                function onOrganizationSave(event, selectedOrganization) {
                    OrganizationsFacade.updateMembers($scope.organization)
