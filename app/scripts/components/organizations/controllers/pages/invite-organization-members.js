...
(function () {
    ...
    angular.module('hexaaApp.components.organizations.controllers.pages')
        .controller('InviteOrganizationMembersCtrl', ['$scope', '$modal', 'dialogService', 'OrganizationsFacade', '$translate', 'InvitationsFacade', 'baseUIAddr', 'events',
        function ($scope, $modal, dialogService, OrganizationsFacade, $translate, InvitationsFacade, baseUIAddr, events) {
            ...
            function onSelectedOrganizationChanged(event, selectedOrganization) {
                ...
                if (selectedOrganization ) {
                    OrganizationsFacade.getOrganization(selectedOrganization).then(onSelectedOrganizationDownloaded);
                    OrganizationsFacade.getRoles(selectedOrganization).then(onOrganizationRolesDownloaded);
                }
            }
        }]);
