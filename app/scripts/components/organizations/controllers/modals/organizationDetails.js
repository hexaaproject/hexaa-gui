...
(function () {
    ...
    angular.module('hexaaApp.components.organizations.controllers.modals')
        ...
        ['$scope', '$modalInstance', 'organizationId', 'OrganizationsProxy', 'dialogService',
            function ($scope, $modalInstance, organizationId, OrganizationsProxy, dialogService) {
                 ...
                 */
                function activate() {
                    OrganizationsProxy.getOrganization(organizationId)
                ...
                function onGetOrganizationSuccess(organization) {
                    ...
                    OrganizationsProxy.getManagers(organization.data.id)
