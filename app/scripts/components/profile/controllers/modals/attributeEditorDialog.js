...
(function () {
    ...
    angular.module("hexaaApp.components.profile.controllers.modals")
        .controller('ProfileAttributeEditorDialogCtrl', ['$scope', '$translate', '$modalInstance', 'targetAttribute', 'targetAttributeSpecification', 'PrincipalProxy',
            function ($scope, $translate, $modalInstance, targetAttribute, targetAttributeSpecification, PrincipalProxy) {
