...
(function () {
    ...
    angular.module('hexaaApp.components.profile.controllers.pages')
        ...
        ['$scope', 'HexaaService', '$translate', 'events', 'PrincipalFacade', 'ServicesFacade', 'OrganizationsFacade',
            'tags', 'dialogService', 'pageTitleService','$q',
            function ($scope, HexaaService, $translate, events, PrincipalFacade, ServicesFacade, OrganizationsFacade,
                      tags, dialogService, pageTitleService,$q) {
                ...
                function activate() {
                    ...
                    $q.all([
                        ...
                        OrganizationsFacade.getOrganizations().then(onGetOrganizationsSuccess)
                    ])
                        .then(function()
                        {
                ...
                function refreshFeed(servicesFilter, organizationsFilter) {
                    ...
                    PrincipalFacade.getNews(($scope.pager.currentPage - 1) * $scope.pager.itemPerPage, $scope.pager.itemPerPage, tags, servicesFilter, organizationsFilter).
