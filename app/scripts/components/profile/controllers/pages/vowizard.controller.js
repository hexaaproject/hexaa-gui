...
(function () {
    ...
    angular.module('hexaaApp.components.profile.controllers.pages')
        .controller('ProfileVOWizardCtrl', ['$scope', 'pageTitleService', '$translate', 'dialogService',
            'EntitlementpacksFacade', 'OrganizationsFacade', '$modal', 'InvitationsFacade',
            'RolesFacade', '$q', '$location',
            function ($scope, pageTitleService, $translate, dialogService,
                EntitlementpacksFacade, OrganizationsFacade,
                      $modal, InvitationsFacade, RolesFacade, $q, $location) {
                ...
                function activate() {
                    ...
                    EntitlementpacksFacade.getPublicEntitlementpacks()
                ...
                function createInvitationModal(asManager, targetInvitation, targetRole) {
                    var modalInstance = $modal.open({
                        ...
                        resolve: {
                            ...
                            invitation: function () {
                                return targetInvitation || InvitationsFacade.new({
                ...
                function createDefaultRole() {
                    ...
                    if (index === -1) {
                        ...
                        var default_role = RolesFacade.new();
                ...
                function createInvitations() {
                    return $q.all(
                        vm.organization.invitations.map(function (invitation) {
                            ...
                            return InvitationsFacade.invite(invitation)
                ...
                function createEntitlementpacks() {
                    $q.all(vm.organization.entitlements.map(function (entitlementpack) {
                            return OrganizationsFacade.addEntitlementpack(vm.organization, entitlementpack)
