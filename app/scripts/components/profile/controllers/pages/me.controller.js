...
(function () {
    ...
    angular.module('hexaaApp.components.profile.controllers.pages')
        ...
        ['$scope', 'HexaaService', '$translate', 'cssInjector', 'themeService', 'PrincipalFacade', 'dialogService', 'settingsService', 'pageTitleService',
            function ($scope, HexaaService, $translate, cssInjector, themeService, PrincipalFacade, dialogService, settingsService, pageTitleService) {
        ...
        function change() {
            PrincipalFacade.updatePrincipal($scope.profile)
