...
(function () {
    ...
    angular.module('hexaaApp.components.profile.controllers.pages')
        ...
        ['$scope', 'dialogService', '$translate', 'AttributeSpecificationsFacade', 'PrincipalFacade', 'ResourceEntity', 'pageTitleService', '$modal',
        function ($scope, dialogService, $translate, AttributeSpecificationsFacade, PrincipalFacade, ResourceEntity, pageTitleService, $modal) {
             ...
             */
            function activate() {
                PrincipalFacade.getAttributeSpecifications()
            ...
            function load(attrspec) {
                ...
                PrincipalFacade.getAttributeValuePrincipals(attrspec.id)
            ...
            function saveAttribute(attrspec, attribute) {
                if (attribute.id == -1) {
                    PrincipalFacade.addAttributeValuePrincipal(attribute)
                        .then(onAddAttributeValuePrincipalSuccess(attrspec, attribute))
                        .catch(onAddAttributeValuePrincipalError);
                }
                else {
                    //update existing
                    PrincipalFacade.updateAttributeValuePrincipal(attribute)
            ...
            function removeAttribute(attrspec, attribute) {
                PrincipalFacade.deleteAttributeValuePrincipal(attribute.id)
