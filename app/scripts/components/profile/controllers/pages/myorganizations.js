...
(function () {
    ...
    angular.module('hexaaApp.components.profile.controllers.pages')
        ...
        ['$scope', 'PrincipalProxy', 'pageTitleService', '$translate', 'dialogService', '$route',
            function ($scope, PrincipalProxy, pageTitleService, $translate, dialogService, $route) {
        ...
        function activate() {
            PrincipalProxy.getMyOrganizations()
